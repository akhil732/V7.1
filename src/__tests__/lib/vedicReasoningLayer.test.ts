...
describe('VedicReasoningLayer', () => {
  ...
  describe('Three-Layer Computation', () => {
    ...
    it('formats ground truth prompt block under token constraints', () => {
      ...
      expect(promptSection).toContain('ACTIVE PERIOD LORDS — TRANSIT FOCUS:');
      expect(promptSection).toContain('MD Lord');
      expect(promptSection).toContain('AD Lord');
      expect(promptSection).toContain('ALL 9 PLANETS — GOCHARA POSITIONS:');
      expect(promptSection).toContain('Sun');
      expect(promptSection).toContain('Moon');
      expect(promptSection).toContain('Mars');
      expect(promptSection).toContain('Mercury');
      expect(promptSection).toContain('Jupiter');
      expect(promptSection).toContain('Venus');
      expect(promptSection).toContain('Saturn');
      expect(promptSection).toContain('Rahu');
      expect(promptSection).toContain('Ketu');
