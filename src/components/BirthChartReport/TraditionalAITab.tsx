...
import { Copy, Check, Search, MessageSquare, Sparkles, AlertCircle } from 'lucide-react';

interface TraditionalAITabProps {
...
// ─── 15 Preloaded Questions for Traditional AI Tab ──────────────────
...
export const PRELOADED_QUESTIONS: PreloadedQuestion[] = [
  {
    ...
    text: 'ఉద్యోగమా లేదా వ్యాపారమా? నా 10వ, 6వ మరియు 7వ భావాల ప్రకారం నా కెరీర్‌కు ఏది అత్యంత అనుకూలం?'
  },
  {
    id: 'q2',
    num: 2,
    ...
    text: 'ప్రేమ వివాహమా లేక పెద్దలు కుదిర్చినదా? నా 5వ, 7వ భావాలు మరియు శుక్రుని స్థానం ప్రకారం నా వివాహం ఎలా ఉంటుంది?'
  },
  {
    id: 'q3',
    num: 3,
    ...
    text: 'ఇతరులు నన్ను ఎందుకు తప్పుగా అర్థం చేసుకుంటారు? నా చంద్రుని స్థితి, లగ్నం లేదా 8వ భావ ప్రభావాలు ఏమిటి?'
  },
  {
    id: 'q4',
    num: 4,
    ...
    category: 'Marriage',
    categoryLabel: 'వివాహం',
    text: 'వివాహ ఆలస్య పరిశీలన: శని ప్రభావం లేదా 7వ భావ స్థితి వల్ల నా వివాహంలో ఆలస్యం ఉందా? ఎప్పుడు యోగం ఉంది?'
  },
  {
    id: 'q5',
    num: 5,
    ...
    category: 'Marriage',
    categoryLabel: 'వివాహం',
    text: 'నా వైవాహిక జీవితం ఎలా ఉంటుంది? నా 7వ భావం, నవాంశ (D-9) మరియు శుక్రుడు నా జీవిత భాగస్వామి గురించి ఏమి చెబుతున్నాయి?'
  },
  {
    id: 'q6',
    num: 6,
    ...
    category: 'Career',
    categoryLabel: 'వృత్తి & కెరీర్',
    text: 'భాగస్వామితో కలిసి వృత్తిపరంగా పనిచేయవచ్చా? నా 7వ మరియు 10వ భావాలు భాగస్వామ్య వ్యాపారానికి సహకరిస్తాయా?'
  },
  {
    id: 'q7',
    num: 7,
    ...
    text: 'విదేశీ ప్రయాణం లేదా శాశ్వత స్థిరనివాసం సాధ్యమేనా? 3వ, 9వ, 12వ భావాలు మరియు రాహువు స్థానం ఏమి సూచిస్తున్నాయి?'
  },
  {
    id: 'q8',
    num: 8,
    ...
    text: 'నా జాతకంలో నీచ భంగ రాజయోగం ఉందా? నీచ గ్రహాల నీచత్వం రద్దయి రాజయోగంగా మారిందా?'
  },
  {
    id: 'q9',
    num: 9,
    ...
    text: 'అత్తమామలతో సంబంధాలు మరియు సఖ్యత ఎలా ఉంటాయి? నా 8వ భావం మరియు గ్రహ స్థితులు ఏమి చెబుతున్నాయి?'
  },
  {
    id: 'q10',
    num: 10,
    ...
    category: 'Marriage',
    categoryLabel: 'కుటుంబం',
    text: 'నా భాగస్వామి నా తల్లిదండ్రులతో కలిసి ఉంటారా? నా 4వ మరియు 9వ భావాలు కుటుంబ సామరస్యం గురించి ఏమి చెబుతున్నాయి?'
  },
  {
    id: 'q11',
    num: 11,
    ...
    category: 'Yogas',
    categoryLabel: 'రాజయోగాలు',
    text: 'నా జాతకంలో ఉన్న రాజయోగాలు ఏ దశా-అంతర్దశా కాలంలో క్రియాశీలమై విజయాన్ని ఇస్తాయి?'
  },
  {
    id: 'q12',
    num: 12,
    ...
    category: 'Mind',
    categoryLabel: 'మనస్తత్వం',
    text: 'అధిక ఆలోచనలు మరియు మానసిక ఆందోళన నివారణ: నా చంద్రుడు, బుధుడు మరియు 5వ భావం మానసిక స్థితిపై ఎలాంటి ప్రభావం చూపుతున్నాయి?'
  },
  {
    id: 'q13',
    num: 13,
    ...
    text: 'నా వేద సూర్య రాశి మరియు స్థానం ఏమిటి? ఇది నా ఆత్మ సంకల్పం, జీవశక్తి మరియు నాయకత్వ లక్షణాలపై ఎలాంటి ప్రభావం చూపుతుంది?'
  },
  {
    id: 'q14',
    num: 14,
    ...
    category: 'Vedic',
    categoryLabel: 'వేద మూలాలు',
    text: 'నా వేద చంద్ర రాశి మరియు నక్షత్రం ఏమిటి? ఇది నా మనస్తత్వం, భావోద్వేగాలు మరియు ప్రవర్తన గురించి ఏమి తెలియజేస్తుంది?'
  },
  {
    id: 'q15',
    num: 15,
    ...
    subtitle: 'లగ్న కుండలి & లగ్నాధిపతి విశ్లేషణ',
    category: 'Vedic',
    categoryLabel: 'వేద మూలాలు',
    text: 'నా లగ్నం మరియు లగ్నాధిపతి బలం ఏమిటి? నా జీవిత దృక్పథం, వ్యక్తిత్వం మరియు మొత్తం జాతక బలం ఎలా ఉన్నాయి?'
  }
];
...
export const TraditionalAITab: React.FC<TraditionalAITabProps> = ({
  birthDetails,
  birthData,
  horoscopeData,
  language = 'te',
  ...
  const {
    ...
    horoscopeData,
    userId: user?.uid,
    persona: 'classical_jyotish',
    language: (language as 'en' | 'hi' | 'te') || 'te'
  });
    ...
    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', height: '100%', background: C.bg, color: C.text, overflow: 'hidden', fontFamily: 'system-ui, -apple-system, sans-serif', borderRadius: 16, border: `1px solid ${C.border}`, boxShadow: `0 8px 24px ${C.shadow}` }}>
      ...
      <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '8px 12px', padding: '10px 14px', borderBottom: `1px solid ${C.border}`, background: C.headerBg, backdropFilter: 'blur(8px)', flexShrink: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', gap: 8, marginLeft: 'auto' }}>
          {/* Static Classical Astro Engine Badge */}
          <div style={{
            fontSize: 11,
            fontWeight: 700,
            ...
            <span>Classical Jyotish Guru</span>
          </div>
      ...
      <div style={{
        ...
        <span style={{ fontSize: 10, color: C.muted, textTransform: 'uppercase', letterSpacing: 0.5, fontWeight: 700, marginRight: 4 }}>
          ACTIVE CONTEXT:
        </span>
        <button style={{
          fontSize: 11, fontWeight: 600, padding: '4px 10px', borderRadius: 12,
          background: C.emptyIconBg, border: `1px solid ${C.accent}`, color: C.accent, cursor: 'pointer', whiteSpace: 'nowrap'
        }}>
          Lagna: {horoscopeData?.lagna || 'Unknown'}
        </button>
        <button style={{
          fontSize: 11, fontWeight: 600, padding: '4px 10px', borderRadius: 12,
          background: C.emptyIconBg, border: `1px solid ${C.accent}`, color: C.accent, cursor: 'pointer', whiteSpace: 'nowrap'
        }}>
          Current Dasha: {activeDashaStr}
        </button>
        <button style={{
          fontSize: 11, fontWeight: 600, padding: '4px 10px', borderRadius: 12,
          background: C.emptyIconBg, border: `1px solid ${C.accent}`, color: C.accent, cursor: 'pointer', whiteSpace: 'nowrap'
        }}>
          Rasi: {horoscopeData?.planets?.find((p: any) => p.name === 'Moon')?.sign || 'Unknown'}
        </button>
      </div>

      {/* Main Body - Traditional Vedic AI Consultation */}
...
export default TraditionalAITab;
