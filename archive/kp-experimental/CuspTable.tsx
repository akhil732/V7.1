...
export const CuspTable: React.FC<CuspTableProps> = ({ houses }) => {
  ...
  return (
    <div className="bg-ds-surface border border-ds-secondary/15 rounded-ds-xl p-4 sm:p-6 shadow-ds-sm space-y-4">
      ...
      {/* Table */}
      <div className="overflow-x-auto rounded-ds-lg border border-ds-secondary/15">
        <table className="w-full text-left text-xs sm:text-sm">
          <thead>
            <tr className="border-b border-ds-secondary/15 text-ds-on-surface-variant font-bold bg-ds-surface-container uppercase text-[10px] tracking-wider">
              ...
              <th className="py-3 px-4 text-ds-primary">Sub Lord</th>
              <th className="py-3 px-4">Sub-Sub</th>
              <th className="py-3 px-4 text-center">Gatekeeper</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-ds-secondary/10 bg-ds-surface text-ds-on-surface">
            {houses.map((house) => {
              ...
              return (
                <tr key={house.number} className="hover:bg-ds-surface-container transition-colors">
